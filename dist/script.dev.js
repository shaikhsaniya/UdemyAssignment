...
// }
var saniya = ['Saniya', 'Mulla', 2037 - 1995, 1995, 'student', ['Tasmiya', 'Saniya', 'Aliya'], true];
console.log(saniya[0]);
var types = [];

for (var i = 0; i < saniya.length; i++) {
  console.log(saniya[i], _typeof(saniya[i])); // types[i] = typeof saniya[i];

  types.push(_typeof(saniya[i]));
}
...
for (var _i = 0; _i < years.length; _i++) {
  ages.push(2037 - years[_i]);
}

console.log(ages);
console.log("---only strings---");

for (var _i2 = 0; _i2 < saniya.length; _i2++) {
  if (typeof saniya[_i2] !== 'string') continue;
  console.log(saniya[_i2], _typeof(saniya[_i2]));
}

console.log("---break with number---");

for (var _i3 = 0; _i3 < saniya.length; _i3++) {
  if (typeof saniya[_i3] === 'number') break;
  console.log(saniya[_i3], _typeof(saniya[_i3]));
}